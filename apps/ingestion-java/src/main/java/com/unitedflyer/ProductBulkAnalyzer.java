...
public class ProductBulkAnalyzer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length != 1) {
            ...
            System.out.println("  mvn exec:java -Dexec.args=\"/path/to/images\"");
            System.out.println("OR (zero-cost mode):");
            System.out.println("  mvn exec:java -DskipAI=true -Dexec.args=\"./sample-images\"");
            return;
        }
        ...
        for (Path imagePath : imageFiles) {
            try {
                ...
                System.out.println("🔍 EMBEDDING TEXT: " + embeddingText);
                System.out.println("🔢 Length: " + embeddingText.length());
